...
import { Market, Product, Vendor } from "../../lib/types";
...
export default function VendorDetailPage() {
  ...
  useEffect(() => {
    ...
    if (foundVendor) {
      ...
      const vendorMkts = markets.filter((m) =>
        foundVendor.marketIds.includes(m.id),
      );
      ...
      <div className="container mx-auto">
                      ...
                      <p className="flex items-center gap-2">
                        ...
                        >
                          ...
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M6.77 3.082C10.581 2.865 13.419 2.865 17.23 3.082C19.215 3.199 20.801 4.785 20.918 6.77C21.135 10.581 21.135 13.419 20.918 17.23C20.801 19.215 19.215 20.801 17.23 20.918C13.419 21.135 10.581 21.135 6.77 20.918C4.785 20.801 3.199 19.215 3.082 17.23C2.865 13.419 2.865 10.581 3.082 6.77C3.199 4.785 4.785 3.199 6.77 3.082ZM17 6C16.4477 6 16 6.44772 16 7C16 7.55228 16.4477 8 17 8C17.5523 8 18 7.55228 18 7C18 6.44772 17.5523 6 17 6ZM7.25 12C7.25 9.37665 9.37665 7.25 12 7.25C14.6234 7.25 16.75 9.37665 16.75 12C16.75 14.6234 14.6234 16.75 12 16.75C9.37665 16.75 7.25 14.6234 7.25 12Z"
                            fill="currentColor"
                          />
                        </svg>
                        <a
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          {vendorMarkets.length === 0 ? (
            <p className="text-gray-600">
              This vendor doesn&apos;t have any markets listed yet.
            </p>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
