...
const mockUser = {
  ...
  reviews: [
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Great selection of organic produce, but a bit crowded on weekends.",
      date: "2025-02-15",
...
export default function ProfilePage() {
  ...
  const sortedReviews = [...mockUser.reviews].sort(
          ...
          <div>
            ...
            <div className="flex mt-3 space-x-4">
              <div className="text-center">
                <span className="block text-xl font-bold text-primary-600">
                  {mockUser.marketsVisited.length}
                </span>
              ...
              <div className="text-center">
                <span className="block text-xl font-bold text-primary-600">
                  {mockUser.eventsAttended.length}
                </span>
                ...
                {visitedMarkets.length > 0 ? (
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {visitedMarkets[0].city}, {visitedMarkets[0].state}
                    </p>
                  </div>
                ) : (
              ...
              <div className="bg-primary-50 p-4 rounded-lg">
                ...
                {attendedEvents.length > 0 ? (
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {attendedEvents[0].date} • {attendedEvents[0].time}
                    </p>
                  </div>
                ) : (
                ...
                {sortedReviews.length > 0 ? (
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {new Date(sortedReviews[0].date).toLocaleDateString()}
                    </p>
                  </div>
                ) : (
            ...
            {visitedMarkets.length > 0 ? (
              <div className="grid grid-cols-1 gap-6">
                {visitedMarkets.map((market) => (
                  <div
                    key={market.id}
                    className="flex flex-col md:flex-row border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition"
                  >
              ...
              <div className="text-center py-8">
                <p className="text-gray-500 mb-4">
                  You haven&apos;t visited any markets yet.
                </p>
                <Link
                  href="/markets"
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center text-sm text-gray-600">
                          ...
                          <span>
                            {eventMarket ? eventMarket.name : "Unknown Market"}
                          </span>
                        </div>
          ...
          <div>
            ...
            {sortedReviews.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-600">
                  Visit some markets and share your experiences with the
                  community!
                </p>
              </div>
            )}
