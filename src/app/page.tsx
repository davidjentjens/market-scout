        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="inline-flex items-center bg-earth-500/90 backdrop-blur px-6 py-3 rounded-lg mb-8 shadow-lg transform -rotate-1 animate-fade-in">
            ...
            <p className="text-white font-semibold tracking-wide text-base">
              Farm to Table, Just Around the Corner
            </p>
          </div>

          <div className="max-w-2xl">
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in">
              Connect with <span className="text-earth-300 italic">Local</span>{" "}
              Food & <span className="text-earth-300 italic">Community</span>
            </h1>
            <p className="text-white text-xl mb-8 animate-fade-in-delay-1">
              Discover vibrant farmers markets in your area, meet local
              producers, and enjoy the freshest seasonal ingredients to
              transform your meals and support your community.
            </p>
            <div className="flex flex-wrap gap-4 animate-fade-in-delay-2">
              ...
              <Link
                href="/calendar"
                className="btn btn-outline btn-lg bg-white/90 backdrop-blur-sm hover:bg-white/80"
              >
                <span className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredMarkets.map((market, index) => (
              <div
                key={market.id}
                className={`scroll-reveal-item delay-${index}`}
              >
          ...
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl font-bold scroll-reveal-item">
              ...
              <Image
                ...
                alt="Market Scout Logo"
                width={32}
                height={32}
                className="inline-block h-8 w-8 mx-1 align-middle"
              />
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 max-w-5xl mx-auto">
            <div className="text-center md:flex-1 scroll-reveal-item delay-1">
              ...
              <p className="text-gray-600">
                Find farmers markets near you with our interactive map.
              </p>
            </div>
            <div className="text-center md:flex-1 scroll-reveal-item delay-2">
              ...
              <p className="text-gray-600">
                Browse local vendors and discover their seasonal offerings.
              </p>
            </div>
            <div className="text-center md:flex-1 scroll-reveal-item delay-3">
              ...
              <p className="text-gray-600">
                Check market hours and see what&apos;s in season before you go.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="lg:w-1/2 scroll-reveal-item">
              ...
              <p className="text-gray-700 mb-6">
                Eating seasonally means enjoying produce at its peak flavor,
                nutrition, and affordability. Discover what local fruits and
                vegetables are fresh this month.
              </p>
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4">
              ...
              <div className="bg-earth-50 p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 scroll-reveal-item delay-2">
                <h3 className="font-display text-xl font-bold text-earth-600 mb-2">
                  Coming Soon
                </h3>
                <ul className="space-y-2">
                  <li className="flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6 scroll-reveal-item">
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700">
                  Market Scout has transformed how I shop for produce. I love
                  being able to easily find which markets are open and
                  what&apos;s in season before heading out. The vendor profiles
                  help me connect with the people growing my food.
                </p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 scroll-reveal-item delay-1">
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700">
                  The seasonal calendar is a game-changer! I&apos;m eating more
                  diverse fruits and vegetables now that I know what&apos;s in
                  season and at peak flavor. The community events have also
                  helped me meet like-minded food enthusiasts in my area.
                </p>
              </div>
              <div className="flex text-yellow-500">
                <svg
            ...
            <div className="bg-white rounded-lg shadow-md p-6 scroll-reveal-item delay-2">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-secondary-100 rounded-full flex items-center justify-center mr-4">
                  <span className="text-secondary-700 font-bold text-xl">
                    D
                  </span>
                </div>
                <div>
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700">
                  As a vendor, Market Scout has connected me with so many new
                  customers who appreciate locally grown produce. The platform
                  makes it easy to share what we&apos;re bringing to market each
                  week and build relationships with the community.
                </p>
              </div>
              <div className="flex text-yellow-500">
                <svg
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white opacity-90 text-lg mb-8 scroll-reveal-item delay-1">
              Start exploring the freshest local produce, artisanal foods, and
              handcrafted goods at farmers markets near you.
            </p>
