...
const ReviewCard: React.FC<ReviewCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-r from-transparent via-primary-200/30 to-transparent -translate-x-full ${isHovered ? "animate-shine" : ""} pointer-events-none`}
      ></div>
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-3">
          ...
          <div className="flex items-center bg-primary-50 px-2 py-1 rounded-full">
            <span className="mr-1 font-bold text-primary-700">
              {review.rating}
            </span>
            <div className="flex">
              {[...Array(5)].map((_, i) => (
        ...
        <div className="mb-4">
          {/* Quotation mark */}
          <svg
            className="h-8 w-8 text-primary-200 mb-1"
            fill="currentColor"
            viewBox="0 0 32 32"
            aria-hidden="true"
          >
          ...
          <p className="text-gray-700 relative z-10">{review.comment}</p>
        </div>
