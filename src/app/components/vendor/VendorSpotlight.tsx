  ...
  return (
    <section className="py-16 bg-earth-50">
      <div className="container mx-auto px-4">
        <h2 className="font-display text-3xl font-bold text-center mb-12">Meet Our Vendors</h2>
        
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {featuredVendors.slice(0, 3).map((vendor) => (
            <div key={vendor.id} className="bg-white rounded-lg shadow-md overflow-hidden group">
