...
export default function RootLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${playfair.variable} ${nunitoSans.variable}`}
    >
      <head>
            ...
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
              <Link href="/">
                <div className="flex items-center">
                  ...
                  />
                  <h3 className="font-sans text-2xl text-primary-600 font-bold">
                    Market Scout
                  </h3>
                </div>
              </Link>
              ...
              <nav className="hidden md:flex space-x-6 items-center">
                <Link
                  href="/markets"
                  className="font-medium text-gray-700 hover:text-primary-500 transition"
                >
                  Markets
                </Link>
                <Link
          ...
          <footer className="bg-earth-900 text-white py-8">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-earth-100 text-sm">
                    Connecting you with local farmers markets and fresh produce
                    in your area.
                  </p>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li>
                      <Link
                        href="/markets"
                        className="text-earth-100 hover:text-primary-300"
                      >
                        Find Markets
                      </Link>
                    </li>
              ...
              <div className="border-t border-earth-700 mt-8 pt-4 text-center text-sm text-earth-300">
                <p>
                  © {new Date().getFullYear()} Market Scout. All rights
                  reserved.
                </p>
              </div>
            </div>
