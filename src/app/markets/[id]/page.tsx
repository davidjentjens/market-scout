...
const DynamicMapView = dynamic(() => import('../../components/map/MapView'), {
  ssr: false,
  loading: () => <div className="h-[300px] bg-earth-100 rounded-lg flex items-center justify-center">Loading map...</div>
});
...
export default function MarketDetailPage() {
  ...
  useEffect(() => {
    ...
    if (foundMarket) {
      ...
      const marketVends = vendors.filter(v => foundMarket.vendorIds.includes(v.id));
  ...
  const goToNextImage = () => {
    ...
    const nextIndex = currentImageIndex === market.images.length - 1 ? 0 : currentImageIndex + 1;
  ...
  const goToPrevImage = () => {
    ...
    setIsTransitioning(true);
    const prevIndex = currentImageIndex === 0 ? market.images.length - 1 : currentImageIndex - 1;
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <h1 className="font-display text-4xl font-bold mb-4 text-primary-800">{market.name}</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h2 className="font-display text-xl font-bold mb-3 text-primary-700">Location</h2>
                  ...
                  <p className="ml-7 mb-4">{market.city}, {market.state} {market.zip}</p>
                ...
                <div>
                  <h2 className="font-display text-xl font-bold mb-3 text-primary-700">Hours</h2>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
          <div className="flex border-b border-gray-200">
            ...
            >
              Events <span className="ml-1 text-sm">({marketEvents.length})</span>
            </button>
          </div>
          ...
          <div className="p-6">
            ...
            {activeTab === 'details' && (
              <div>
                <div className="mb-8">
                  <h2 className="font-display text-2xl font-bold mb-4">Market Map</h2>
                ...
                <div>
                  <h2 className="font-display text-2xl font-bold mb-4">Shopping Tips</h2>
                  <div className="bg-primary-50 p-4 rounded-lg">
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span>Bring your own bags to reduce waste and make carrying purchases easier.</span>
                      </li>
                      <li className="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span>Arrive early for the best selection, especially for popular seasonal items.</span>
                      </li>
                      <li className="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span>Bring small bills and change to make transactions easier for vendors.</span>
                      </li>
                      <li className="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span>Don&apos;t be afraid to ask vendors about their growing practices and for cooking tips.</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            {activeTab === 'vendors' && (
              <div>
                <h2 className="font-display text-2xl font-bold mb-4">Vendors at this Market</h2>
                
                {marketVendors.length === 0 ? (
                  <p className="text-gray-600">No vendor information available for this market.</p>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {marketVendors.map(vendor => (
                      ...
                      >
                        ...
                        <div className="p-4">
                          <h3 className="font-display text-lg font-bold mb-1 group-hover:text-primary-600 transition-colors">{vendor.name}</h3>
                          <p className="text-sm text-gray-600 line-clamp-2 mb-3">{vendor.bio}</p>
            ...
            {activeTab === 'events' && (
              <div>
                ...
                {marketEvents.length === 0 ? (
                  <p className="text-gray-600">No upcoming events scheduled for this market.</p>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
